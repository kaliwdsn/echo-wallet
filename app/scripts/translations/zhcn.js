...
ENS_Finalize_content            :  'Finalizing this name assigns the ENS name to the winning bidder. The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.01 ECHO. Any non-winners will also be refunded.',
...
ENS_Helper_4                    :  'Decide the maximum amount of ECHO you are willing to pay for the name (your <u>Bid Amount</u>). Ensure that account has enough to cover your bid + 0.01 ECHO for gas.',
...
ENS_Helper_16                   :  'The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.01 ECHO.',
...
tx_notFound_4               : 'Please use the dropdown in the top-right & select a different ECHO node (e.g. `ECHO (Etherscan.io)` or `ECHO (Infura.io)` or `ECHO (MyEtherWallet)`) and check again.',
...
GAS_LIMIT_Desc              : 'Gas limit is the amount of gas to send with your TX. `TX fee` = gas price * gas limit & is paid to miners for including your TX in a block. Increasing this number will not get your TX mined faster. Sending ECHO = `21000`. Sending Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> ECHO here](https://www.myetherwallet.com/helpers.html)',
...
NAV_MyWallets               : '我的钱包 ',
NAV_Offline                 : '离线发送 ',
NAV_SendEther               : '发送ECHO币 / 发送代币 ', //combined these tabs
...
MEW_Tagline                 : '开源JavaScript客户端ECHO币钱包 ',
CX_Tagline                  : '开源JavaScript客户端ECHO币钱包Chrome扩展 ',

/* Footer */
FOOTER_1                    : '一个开源的生成ECHO坊钱包和发送交易的JavaScript客户端工具 ',
FOOTER_1b                   : '创建者 ',
FOOTER_2                    : '欢迎捐赠我们： ',
...
ADD_Warning_1               : '你可以钱包标签页面添加任何要查看的账户，不需要上传私钥。这不意味着你可以使用钱包和发送ECHO币。 ',
ADD_Label_5                 : '输入地址： ',
ADD_Label_6                 : '解锁钱包 ',
...
SENDModal_Title             : '警告！ ',
/* full sentence reads "You are about to send "10 ECHO" to address "0x1234". Are you sure you want to do this? " */
SENDModal_Content_1         : '你将发送 ',
SENDModal_Content_2         : '到地址 ',
SENDModal_Content_3         : '你确定这样做吗？ ',
SENDModal_Content_4         : '注意：如果你遇到错误，你最有可能向你的账户添加ECHO币，用以支付发送代币所需的gas。 Gas is paid in ether.Gas用ECHO币支付。 ',
SENDModal_No                : '不，离开这里。 ',
...
TRANS_data                  : '数据： ',
TRANS_gas                   : 'Gas Limit： ',
TRANS_sendInfo              : '一笔标准交易需要21000gas，花费0.000441ECHO币。我们将gas价格设为0.000000021ECHO币，略高于最低价格，以保证交易被快速打包。我们不收取交易费用。 ',
...
SWAP_init_2                 : " for ", // "I want to swap my X ECHO for X BTC"
...
SWAP_progress_3             : "Received! ", // ECHO Received!
SWAP_progress_4             : "Sending your {{orderResult.output.currency}} ",
SWAP_progress_5             : "Order Complete ",
SWAP_order_CTA              : "Please send ", // Please send 1 ECHO...
SWAP_unlock                 : "Unlock your wallet to send ECHO or Tokens directly from this page. ",
...
ERROR_17                    : '你的账户需要至少0.01ECHO币，已支付gas费用。请添加一些ECHO币，再次尝试。 ',
...
HELP_4_Desc_2               : 'Navigate to the "发送ECHO币 / 发送代币" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "发送ECHO币 / 发送代币" page. ',
...
HELP_4CX_Desc_12            : 'Using "发送ECHO币 / 发送代币" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "发送ECHO币 / 发送代币" page. ',
...
HELP_9_Title                : '9) Is the "发送ECHO币 / 发送代币" page offline? ',
